...
Aliases can have any access modifier. It may be useful/desirable to have aliases for other things such as namespaces etc. For that reason, or just for increased clarity in might be preferable to use the keyword pair `type alias` for type aliases.
